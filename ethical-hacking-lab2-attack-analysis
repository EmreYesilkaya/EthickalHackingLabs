...
|-----------|---------------|---------------------------------------------|
| 1         | 192.168.0.3   | 1 14.50 ms node1.example.com (192.168.0.3)  |
| 2         | 192.168.0.227 | 1 96.50 ms node2.example.com (192.168.0.227)|
| 3         | 192.168.0.226 | 1 70.00 ms node3.example.com (192.168.0.226)|
| 4         | 192.168.0.220 | 1 28.75 ms node4.example.com (192.168.0.220)|
| 5         | 192.168.0.190 | 1 45.00 ms node5.example.com (192.168.0.190)|
| ...       |               |                                             |
| 22        |               |                                             |
